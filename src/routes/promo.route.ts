...
import { createPromoCode, deletePromoCode, getAllPromoCodes, getPromoCodeById, makeActive, updatePromoCodeById } from "../controllers/promoCode/PromoCode.controller";
